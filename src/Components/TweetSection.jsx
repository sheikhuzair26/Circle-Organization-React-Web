          ...
          <Row>
            ...
            <Col>
              <div className="activties">
                ...
                <li>
                  Anusha Fatima Makes Pakistan Proud at Global Tech Competition
                  in China
                </li>
                <li>
                ...
                <li>
                  Breaking Barriers: CIRCLE’s Report on Women’s Entrepreneurship
                  in Pakistan
                </li>
                <li>
                  CIRCLE Highlights Women Techpreneurs in Islamabad with Startup
                  Grind Islamabad for She Loves Tech Pakistan
                </li>
              </div>
            </Col>
          </Row>
